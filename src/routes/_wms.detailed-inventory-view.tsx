...
const STORAGE_ROWS: string[][] = [
  ["600179", "boAt Airdopes 141 TWS Earbuds", "boAt Lifestyle", "3 (Bulk line)", "—", "—", "MD-LPN-1017", "01/04/2026", "01/04/2021", "10", "1299", "SELLABLE", "GOOD", "Prime", "1250", "1250", "0", "NO", "BULK16-02", "-3.6145", "03/04/2023 00:59", "—", "1299", "Electronics"],
  ["600822", "boAt Rockerz 450 Bluetooth Headphones", "Imagine Marketing", "3 (Bulk line)", "—", "—", "MD-LPN-1017", "03/01/2026", "03/01/2021", "1", "1499", "SELLABLE", "GOOD", "Prime", "24", "24", "0", "NO", "BULK16-02", "-8.4337", "03/04/2023 00:59", "—", "1499", "Electronics"],
  ["600868", "boAt Bassheads 100 Wired Earphones", "boAt Lifestyle", "3 (Bulk line)", "—", "—", "MD-LPN-1017", "04/01/2026", "04/01/2021", "50", "399", "SELLABLE", "GOOD", "Prime", "1250", "1250", "0", "NO", "BULK16-02", "-8.379", "03/04/2023 00:59", "—", "399", "Electronics"],
  ["600900", "boAt Stone 350 Bluetooth Speaker", "Cloudtail India", "1 (Pick line)", "—", "—", "MD-LPN-129", "01/08/2023", "01/08/2018", "30", "1999", "SELLABLE", "GOOD", "Prime", "6", "6", "0", "NO", "BULK10-14", "-56.9551", "03/04/2023 00:51", "—", "1999", "Electronics"],
  ["601000", "boAt Wave Call Smartwatch", "Appario Retail", "1 (Pick line)", "—", "—", "MD-LPN-129", "01/08/2025", "01/08/2020", "1", "1799", "SELLABLE", "GOOD", "Prime", "12", "12", "0", "NO", "BULK10-14", "-16.9222", "03/04/2023 00:51", "—", "1799", "Electronics"],
  ["601002", "boAt Type-C 500 Charging Cable", "RetailEZ", "1 (Pick line)", "—", "—", "MD-LPN-129", "01/06/2027", "01/06/2022", "30", "499", "SELLABLE", "GOOD", "Prime", "3", "2", "1", "NO", "BULK10-14", "19.7152", "03/04/2023 00:51", "—", "499", "Electronics"],
];
...
const PICKED_ROWS: string[][] = [
  ["8904040000018", "boAt Airdopes 161 TWS Earbuds", "boAt Lifestyle", "—", "SLR01-L2", "01/08/2033", "01/08/2023", "1", "1499", "ok", "5", "7268484", "part-picked", "SLR01-L2", "71.5029", "Electronics"],
  ["LC1018", "boAt Rockerz 255 Neckband Earphones", "Imagine Marketing", "—", "MD-LPN-13", "01/09/2033", "01/09/2023", "12", "1199", "ok", "1", "82737474", "part-picked", "BULK09-13", "72.3515", "Electronics"],
  ["LC1018", "boAt Rockerz 255 Neckband Earphones", "Imagine Marketing", "—", "MD-LPN-13", "01/09/2033", "01/09/2023", "12", "1199", "ok", "2", "46477888", "part-picked", "BULK09-13", "72.3515", "Electronics"],
  ["OT1771", "boAt Bassheads 152 Wired Earphones", "Cloudtail India", "—", "MD-LPN-86", "05/01/2028", "05/01/2023", "40", "499", "ok", "776", "REQ184459", "picked", "BULK13-01", "31.5991", "Electronics"],
  ["OT1771", "boAt Bassheads 152 Wired Earphones", "Cloudtail India", "—", "MD-LPN-1620", "01/11/2027", "01/11/2022", "40", "499", "ok", "776", "REQ184459", "picked", "SLR38-L3", "28.0394", "Electronics"],
  ["8904040000025", "boAt Stone 650 Bluetooth Speaker", "Appario Retail", "—", "MD-LPN-269", "01/03/2028", "01/03/2023", "90", "2499", "ok", "1800", "REQ195863", "picked", "BULK10-02", "34.6470", "Electronics"],
  ["LC2050", "boAt Storm Smartwatch", "boAt Lifestyle", "—", "MD-LPN-44", "01/06/2026", "01/06/2023", "12", "1999", "ok", "24", "REQ200145", "part-packed", "SLR12-L1", "58.2010", "Electronics"],
  ["LC3099", "boAt Aavante Bar 1160 Soundbar", "RetailEZ", "—", "MD-LPN-77", "01/03/2027", "01/03/2024", "6", "5499", "ok", "10", "REQ200890", "packed", "SLR05-L2", "88.4012", "Electronics"],
];
...
const RECEIVING_ROWS: string[][] = [
  ["600179", "boAt Airdopes 141 TWS Earbuds", "boAt Lifestyle", "RX-LPN-204", "Electronics", "—", "1299", "01/04/2026", "01/04/2021", "MOD-26091444", "ok", "SELLABLE", "GRN184459", "10", "-3.6145", "1250", "Vikas Chauhan", "03/04/2023 00:59"],
  ["600822", "boAt Rockerz 450 Bluetooth Headphones", "Imagine Marketing", "RX-LPN-204", "Electronics", "—", "1499", "03/01/2026", "03/01/2021", "MOD-26091445", "ok", "SELLABLE", "GRN184460", "1", "-8.4337", "24", "Umesh Yadav", "03/04/2023 01:10"],
  ["600868", "boAt Bassheads 100 Wired Earphones", "boAt Lifestyle", "RX-LPN-205", "Electronics", "—", "399", "04/01/2026", "04/01/2021", "MOD-26091446", "reject", "NON-SELLABLE", "GRN184461", "50", "-8.379", "120", "Rizwan", "03/04/2023 01:22"],
  ["600900", "boAt Stone 350 Bluetooth Speaker", "Cloudtail India", "RX-LPN-206", "Electronics", "—", "1999", "01/08/2025", "01/08/2020", "MOD-26091447", "ok", "SELLABLE", "GRN184462", "30", "21.4521", "60", "Priyanka Gupta", "03/04/2023 02:01"],
  ["601000", "boAt Wave Call Smartwatch", "Appario Retail", "RX-LPN-206", "Electronics", "LOT1", "1799", "01/08/2027", "01/08/2022", "MOD-26091448", "ok", "SELLABLE", "GRN184463", "1", "44.8901", "48", "HHT3", "03/04/2023 02:15"],
  ["601002", "boAt Type-C 500 Charging Cable", "RetailEZ", "RX-LPN-207", "Electronics", "—", "499", "01/06/2027", "01/06/2022", "MOD-26091449", "reject", "NON-SELLABLE", "GRN184464", "30", "19.7152", "300", "Pradeep", "03/04/2023 02:40"],
  ["601005", "boAt Aavante Bar 1160 Soundbar", "RetailEZ", "RX-LPN-208", "Electronics", "—", "5499", "01/03/2027", "01/03/2024", "MOD-26091450", "ok", "SELLABLE", "GRN184465", "6", "88.4012", "36", "Yogesh", "03/04/2023 03:05"],
];
...
const CANCEL_ROWS: string[][] = [
  ["600179", "boAt Airdopes 141 TWS Earbuds", "boAt Lifestyle", "1299", "Electronics", "Table01", "—", "—", "CANCEL-LPN", "01/04/2026", "01/04/2021", "—", "10", "1299", "boAt_Dasna", "10", "-3.6145", "05/05/2023 14:10"],
  ["600822", "boAt Rockerz 450 Bluetooth Headphones", "Imagine Marketing", "1499", "Electronics", "Table01", "—", "—", "CANCEL-LPN", "03/01/2026", "03/01/2021", "—", "1", "1499", "boAt_Dasna", "1", "-8.4337", "05/05/2023 14:10"],
  ["600868", "boAt Bassheads 100 Wired Earphones", "boAt Lifestyle", "399", "Electronics", "Table08", "—", "—", "CANCEL-LPN", "04/01/2026", "04/01/2021", "—", "50", "399", "boAt_Dasna", "50", "-8.379", "25/09/2023 21:22"],
  ["600900", "boAt Stone 350 Bluetooth Speaker", "Cloudtail India", "1999", "Electronics", "Table08", "—", "—", "CANCEL-LPN", "01/08/2025", "01/08/2020", "—", "30", "1999", "boAt_Dasna", "30", "21.4521", "25/09/2023 21:23"],
  ["601002", "boAt Type-C 500 Charging Cable", "RetailEZ", "499", "Electronics", "Table08", "MOD-26091449", "LOT1", "CANCEL-LPN", "01/06/2027", "01/06/2022", "—", "30", "499", "boAt_Dasna", "30", "19.7152", "08/04/2026 11:59"],
  ["601005", "boAt Aavante Bar 1160 Soundbar", "RetailEZ", "5499", "Electronics", "Table08", "—", "—", "CANCEL-LPN", "01/03/2027", "01/03/2024", "—", "6", "5499", "boAt_Dasna", "6", "88.4012", "10/04/2026 14:26"],
];
...
const MISSING_ROWS: string[][] = [
  ["600868", "boAt Bassheads 100 Wired Earphones", "boAt Lifestyle", "Electronics", "3 (Bulk line)", "—", "—", "MD-LPN-1017", "—", "04/01/2026", "04/01/2021", "—", "50", "399", "4", "NO", "BULK16-02", "-8.379", "12/02/2026 10:14", "Not found during cycle count"],
  ["600900", "boAt Stone 350 Bluetooth Speaker", "Cloudtail India", "Electronics", "1 (Pick line)", "—", "—", "MD-LPN-129", "—", "01/08/2025", "01/08/2020", "—", "30", "1999", "2", "NO", "BULK10-14", "21.4521", "18/02/2026 09:30", "Short pick — quantity mismatch"],
  ["601002", "boAt Type-C 500 Charging Cable", "RetailEZ", "Electronics", "1 (Pick line)", "—", "LOT1", "MD-LPN-129", "BATCH-7", "01/06/2027", "01/06/2022", "—", "30", "499", "5", "NO", "BULK10-14", "19.7152", "22/02/2026 16:48", "Bin empty on retrieval"],
  ["601005", "boAt Aavante Bar 1160 Soundbar", "Appario Retail", "Electronics", "1 (Pick line)", "—", "—", "MD-LPN-77", "—", "01/03/2027", "01/03/2024", "—", "6", "5499", "1", "NO", "SLR05-L2", "88.4012", "01/03/2026 11:05", "Reported missing by picker"],
];
...
const invTabs: InvTab[] = [
  {
    ...
    filterCols: ["Qc Status", "Category", "Shelf Life %", "Created By", "Category Code"],
  ...
  },
  {
    ...
    filterCols: ["Qc Status", "Status", "Shelf Life %", "Category Code"],
